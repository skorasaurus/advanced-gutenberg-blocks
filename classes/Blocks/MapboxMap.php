...
class Gmap {
  ...
  public function run() {
		...
		$args = array(
			...
			'description' => __( "Insert a Mapbox Map in your content, the easy way.", 'advanced-gutenberg-blocks' ),
			'options_callback' => array( $this, 'settings' ),
		);

		Blocks::register_block( 'advanced-gutenberg-blocks/mapboxmap', __( 'Mapbox Map', 'advanced-gutenberg-blocks' ), $args );
	...
	public function register_render() {
		...
		register_block_type(
      'advanced-gutenberg-blocks/mapboxmap',
